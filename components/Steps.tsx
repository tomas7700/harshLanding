  ...
  return (
    <section className='flex  flex-col  text-[#fff] gap-4 px-3 '>
      <div className='flex  flex-col items-center'>
        ...
        <p className=' min-w-[300px] max-w-[700px] text-center text-[18px] mt-5'>Do you love watching videos? We do too!
<br />
<br />
...
<br />
<br />
      <span className='font-extrabold text-2xl'> I make al this in three steps </span>   
        </p>
      </div>
